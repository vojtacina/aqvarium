...
export default function AppContainer({ children }) {
    ...
    return (
        <div className="w-full flex justify-between  relative">
            ...
            <div className="max-w-6xl w-full lg:pl-24px lg:pt-8px">
                {children}
            </div>
            <div></div>
            <div className="hidden dark:text-white lg:flex fixed bottom-0 top-0 left-0 p-24px lg:w-200px dark:bg-gray-800 bg-gray-50 bg-opacity-50 flex-col gap-y-16px shadow-lg">
                ...
                <Link href="/dashboard">
                <div className="flex items-center opacity-50 hover:opacity-100 hover:text-purple dark:hover:text-white cursor-pointer">
                ...
                <div
                onClick={() => logout()}
                className="flex items-center opacity-50 hover:opacity-100 hover:text-purple dark:hover:text-white cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-16px h-16px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
