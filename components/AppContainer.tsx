...
export default function AppContainer({ children }) {
    ...
    return (
        <div className="w-full flex justify-between  relative">
            ...
            <div></div>
            <div className="hidden lg:flex fixed bottom-0 top-0 left-0 p-24px lg:w-200px bg-gray-50 bg-opacity-50 flex-col gap-y-16px shadow-lg">
                ...
                <div className="w-full h-1px bg-gray-300 bg-opacity-50"></div>
                <Link href="/dashboard">
